...
const Team = () => {
    return (
        <div id='Team' className='flex flex-col items-center mt-32 px-[5%]'>
            ...
            <div className='flex flex-col items-center mt-10 w-full sm:px-[10%]'>
                <ul className='flex justify-center w-full'>
                    <div className=' grid justify-items-center lg:w-full md:grid-flow-row grid-cols-1 grid-rows-2 md:grid-cols-2 md:grid-rows-1 lg:grid-cols-1 lg:grid-rows-2  gap-[5px] md:gap-x-[30px] '>
